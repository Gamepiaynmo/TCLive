...
public class LoginStatus {
	...
	static String static_tokenUrl = "https://passport.baidu.com/v2/api/?getapi&tpl=tb&apiver=v3&tt=%d&class=login&gid=%s&logintype=dialogLogin&callback=%s";
	static String static_rsaUrl = "https://passport.baidu.com/v2/getpublickey?token=%s&tpl=tb&apiver=v3&tt=%d&gid=%s&callback=%s";
